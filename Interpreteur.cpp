...
Noeud* Interpreteur::instPour(){
    testerEtAvancer("pour");            //for
    testerEtAvancer("(");               //(
    Noeud* affect1 = nullptr;
    Noeud* affect2 = nullptr;
    if(m_lecteur.getSymbole()=="<VARIABLE>"){
            affect1 = affectation(); //on mémorise la 1ere affectation //type var
                
   }
    testerEtAvancer(";");
    Noeud* condition = expression(); // on mémorise la condition      //  instruction
    testerEtAvancer(";");    
   
    if(m_lecteur.getSymbole()=="<VARIABLE>"){
             affect2 = affectation(); //on mémorise la 2nd affectation //type var
