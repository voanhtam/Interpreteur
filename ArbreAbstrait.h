...
//  et ses 2 fils : la condition du si et la séquence d'instruction associée
  public:
    NoeudInstSi(Noeud* condition, Noeud* sequence, Noeud* sinon,vector<Noeud *>sequence_sinonsi,vector<Noeud *>condition_sinonsi);
  ...
  private:
    Noeud*  m_condition;
    Noeud*  m_sequence;
    vector<Noeud *> m_condi_sinonsi;
    vector<Noeud *> m_seq_sinonsi;
    Noeud* seq_sinon;
};
...
class NoeudInstTantQue : public Noeud {
    ...
    ~NoeudInstTantQue() {}
    int executer(); //execute l'instruction tant que la condition est vraie
